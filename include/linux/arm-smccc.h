...
#define ARM_SMCCC_KVM_FUNC_ASYNC_PF		66
...
#define ARM_SMCCC_KVM_FUNC_ASYNC_PF_IRQ		2
#define ARM_SMCCC_KVM_FUNC_ASYNC_PF_ENABLE	3
#define ARM_SMCCC_KVM_FUNC_ASYNC_PF_IRQ_ACK	4
